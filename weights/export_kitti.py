...
class KittiConverter:
    def __init__(self,
                 nusc_kitti_dir: str = '/content/drive/Shareddrives/EE Project 2023/dataset/nuscenes_kitti',
                 cam_name: str = 'CAM_FRONT',
                 lidar_name: str = 'LIDAR_TOP',
                 image_count: int = 31206,
        ...
        self.nusc = NuScenes(version='v1.0-mini', dataroot='/content/drive/Shareddrives/EE Project 2023/dataset', verbose=True)
    ...
    def nuscenes_gt_to_kitti(self) -> None:
        ...
        for sample_token in sample_tokens:
            token_str = '{:06d}'.format(token_idx)
            # Get sample data.
            ...
            dst_im_path = os.path.join(image_folder, token_str + '.png')
            ...
            calib_path = os.path.join(calib_folder, token_str + '.txt')
            ...
            # Write label file.
            label_path = os.path.join(label_folder, token_str + '.txt')
            if os.path.exists(label_path):
                print('Skipping existing file: %s' % label_path)
                continue
            else:
                print('Writing file: %s' % label_path)
            valid_categories = ['pedestrian', 'car', 'bicycle', 'truck', 'motorcycle', 'bus']
            with open(label_path, "w") as label_file:
                for sample_annotation_token in sample_annotation_tokens:
                    ...
                    if detection_name not in valid_categories:
                        continue
