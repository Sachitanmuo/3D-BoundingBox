...
import os
#model_path = os.path.abspath(os.path.dirname(__file__)) + '/weights/best.pt'
# Load a model
...
if __name__ == '__main__':
    img_path = os.path.abspath(os.path.dirname(__file__)) + '/eval/image_2./000008.png'
    model_path = os.path.abspath(os.path.dirname(__file__)) + '/weights/best.onnx'
